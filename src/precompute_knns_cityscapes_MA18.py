...
@hydra.main(config_path="configs", config_name="train_config_cityscapes_MA18.yaml")
def my_app(cfg: DictConfig) -> None:
    print(OmegaConf.to_yaml(cfg))
    # for i in range(0, cfg.client_num):
    ...
    for i in range(1,cfg.client_num+1):
        ...
        image_sets = ["train"]
        dataset_names = [f"MA{cfg.client_num}_cityscapes{i+1}"]
        crop_types = ["five"]  # cityscapes
                    ...
                    if not os.path.exists(feature_cache_file):
                        ...
                        with torch.no_grad():
                            ...
                            for i in tqdm(range(0, normed_feats.shape[0], step)):
                                ...
                                # all_nns.append(torch.topk(pairwise_sims, 5)[1])  #for extremely non-iid, a = 0.1
                                del pairwise_sims
